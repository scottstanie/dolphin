...
from ._profiling import log_input_read_profile
...
def run(
    ...
    # One-shot log of input chunking/compression to inform profiling.
    log_input_read_profile(non_compressed_slcs[0], subdataset=subdataset)
    layover_shadow_mask = (
