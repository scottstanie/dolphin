...
def run(
    ...
    if len(phase_linked_slcs) > 0:
        ...
        (
            ...
            two_hop_closure_scales=cfg.phase_linking.two_hop_closure_scales,
            write_split_half=cfg.phase_linking.write_split_half,
            crlb_looks=cfg.phase_linking.crlb_looks,
            block_shape=cfg.worker_settings.block_shape,
